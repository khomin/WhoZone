          ...
          return Scaffold(
            body: Stack(children: [
              Builder(builder: (context) {
                switch (context.select<AppModel, PageType>((v) => v.page)) {
                  case PageType.home:
            ...
            bottomNavigationBar: Container(
              ...
              child: Builder(builder: (context) {
                var page = context.select<AppModel, PageType>((v) => v.page);
                return SafeArea(
                  child: BottomNavigationBar(
                    ...
                    selectedItemColor:
                        Theme.of(context).colorScheme.bottomNavIconSelected,
                    unselectedItemColor:
                        Theme.of(context).colorScheme.bottomNavIconUnselected,
                    selectedLabelStyle:
                    ...
                    onTap: (value) async {
                      context.read<AppModel>().setPage(PageType.values[value]);
                    },
                  ),
                );
              }),
